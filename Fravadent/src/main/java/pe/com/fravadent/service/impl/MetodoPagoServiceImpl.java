...
public class MetodoPagoServiceImpl implements MetodoPagoService {
    ...
    public List<MetodoPagoDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, MetodoPagoDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<MetodoPagoDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, MetodoPagoDTO.class)).collect(Collectors.toList());
    }

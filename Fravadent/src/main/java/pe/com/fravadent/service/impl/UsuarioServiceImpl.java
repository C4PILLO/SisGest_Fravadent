...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public List<UsuarioDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, UsuarioDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<UsuarioDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, UsuarioDTO.class))
				.collect(Collectors.toList());
	}

...
public class CompraServiceImpl implements CompraService {
	...
	public CompraServiceImpl(CompraRepository repositorio, ModelMapper modelMapper, DetalleCompraRepository detalleRepo,
	...
	public List<CompraDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, CompraDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<CompraDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, CompraDTO.class))
				.collect(Collectors.toList());
	}

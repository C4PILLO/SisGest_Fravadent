...
public class DepartamentoServiceImpl implements DepartamentoService {
    ...
    public List<DepartamentoDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, DepartamentoDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<DepartamentoDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, DepartamentoDTO.class)).collect(Collectors.toList());
    }

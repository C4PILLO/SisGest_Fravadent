...
public class UnidadMedidaServiceImpl implements UnidadMedidaService {
	...
	public List<UnidadMedidaDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, UnidadMedidaDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<UnidadMedidaDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, UnidadMedidaDTO.class))
				.collect(Collectors.toList());
	}

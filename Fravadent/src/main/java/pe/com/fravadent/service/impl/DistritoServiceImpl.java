...
public class DistritoServiceImpl implements DistritoService {
    ...
    public List<DistritoDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, DistritoDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<DistritoDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, DistritoDTO.class)).collect(Collectors.toList());
    }

...
public class TipoComprobanteServiceImpl implements TipoComprobanteService {
	...
	public List<TipoComprobanteDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, TipoComprobanteDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<TipoComprobanteDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, TipoComprobanteDTO.class))
				.collect(Collectors.toList());
	}

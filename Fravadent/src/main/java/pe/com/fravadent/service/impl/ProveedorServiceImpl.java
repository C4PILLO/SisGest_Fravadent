...
public class ProveedorServiceImpl implements ProveedorService {
    ...
    public List<ProveedorDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, ProveedorDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<ProveedorDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, ProveedorDTO.class)).collect(Collectors.toList());
    }

...
public class TipoDocumentoServiceImpl implements TipoDocumentoService {
	...
	public List<TipoDocumentoDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, TipoDocumentoDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<TipoDocumentoDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, TipoDocumentoDTO.class))
				.collect(Collectors.toList());
	}

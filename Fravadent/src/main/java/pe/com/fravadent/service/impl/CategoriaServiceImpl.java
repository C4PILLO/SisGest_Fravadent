...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    public List<CategoriaDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, CategoriaDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<CategoriaDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, CategoriaDTO.class)).collect(Collectors.toList());
    }

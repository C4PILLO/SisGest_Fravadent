...
public class DetalleCompraServiceImpl implements DetalleCompraService {
    ...
    public List<DetalleCompraDTO> findAll() {
        return repositorio.findAll().stream().map(e -> modelMapper.map(e, DetalleCompraDTO.class)).collect(Collectors.toList());
    }

    @Override
    public List<DetalleCompraDTO> findAllCustom() {
        return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, DetalleCompraDTO.class)).collect(Collectors.toList());
    }

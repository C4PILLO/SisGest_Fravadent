...
public class ProductoServiceImpl implements ProductoService {
	...
	public List<ProductoDTO> findAll() {
		return repositorio.findAll().stream().map(e -> modelMapper.map(e, ProductoDTO.class))
				.collect(Collectors.toList());
	}

	@Override
	public List<ProductoDTO> findAllCustom() {
		return repositorio.findAllCustom().stream().map(e -> modelMapper.map(e, ProductoDTO.class))
				.collect(Collectors.toList());
	}

...
public class UsuarioController extends GenericoController<UsuarioDTO> {
	...
	public UsuarioController(UsuarioService servicio, TipoDocumentoService tipoDocumentoService,
			SexoService sexoService, DistritoService distritoService, RolService rolService) {
